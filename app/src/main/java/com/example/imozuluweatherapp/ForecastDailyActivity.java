...
public class ForecastDailyActivity extends AppCompatActivity {
    String CITY1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forecast_daily);
    ...
    class weatherTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String args[]) {
            String response = HttpRequest.executeGet("https://api.openweathermap.org/data/2.5/weather="+CITY1+"&units=metric&appid=d13eb5c0ddfb97f2590ae5098c86be63");
            return response;
        }
        @Override
